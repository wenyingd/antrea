...
# Source https://raw.githubusercontent.com/kubernetes-sigs/iptables-wrappers/9e6ce59c864623ea71a6f7d59c35fcb13a919b87/iptables-wrapper-installer.sh
# Changes:
# - Change /usr/sbin/ to /usr/bin in line 47 and line 50 to detect the style of alternatives.
...
if [ -x /usr/bin/alternatives ]; then
