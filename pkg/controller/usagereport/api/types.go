...
// MemStats is information retrieved from the Go runtime by calling runtime.MemStats.
...
type RuntimeInfo struct {
	...
	MemoryStats  MemStats `json:"memoryStats"`
}
...
type ClusterInfo struct {
	...
	ControllerRuntimeInfo RuntimeInfo `json:"controllerRuntimeInfo"`
