...
// NewForConfigAndClient creates a new SystemV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SystemV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &SystemV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new SystemV1beta1Client for the given config and
