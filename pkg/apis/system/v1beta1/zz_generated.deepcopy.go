...
func (in *NodeCPUInfo) DeepCopyInto(out *NodeCPUInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeCPUInfo.
func (in *NodeCPUInfo) DeepCopy() *NodeCPUInfo {
	if in == nil {
		return nil
	}
	out := new(NodeCPUInfo)
...
func (in *NodeCPUInfo) DeepCopyObject() runtime.Object {
